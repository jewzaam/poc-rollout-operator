...
import (
	...
	pocrolloutoperatorv1alpha1 "github.com/jewzaam/poc-rollout-operator/pkg/apis/pocrolloutoperator/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &pocrolloutoperatorv1alpha1.AppService{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &pocrolloutoperatorv1alpha1.AppService{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileAppService) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &pocrolloutoperatorv1alpha1.AppService{}
...
func newPodForCR(cr *pocrolloutoperatorv1alpha1.AppService) *corev1.Pod {
